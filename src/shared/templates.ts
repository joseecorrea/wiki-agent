...
At the end of your response, if you can estimate it, mention the approximate token savings generated by your work (wiki pages consulted vs. summary length). If your environment supports it, you may report this via the \`wiki_stats\` MCP tool.
`,
...
At the end of your response, if you can estimate it, mention the approximate token savings generated by your work (source size vs. condensed pages created). If your environment supports it, you may report this via the \`wiki_stats\` MCP tool.
`,
...
At the end of your response, if you can estimate it, mention the approximate token savings generated by your work (pages updated vs. manual search and edit effort avoided). If your environment supports it, you may report this via the \`wiki_stats\` MCP tool.
`,
...
At the end of your response, if you can estimate it, mention the approximate token savings generated by your work (undocumented facts preserved vs. future rediscovery effort). If your environment supports it, you may report this via the \`wiki_stats\` MCP tool.
`,
...
At the end of your response, if you can estimate it, mention the approximate token savings generated by your work (full wiki scan avoided vs. targeted lint report). If your environment supports it, you may report this via the \`wiki_stats\` MCP tool.
`,
};
